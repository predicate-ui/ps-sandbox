...
class OAuthGmailUser():
    ...
    def create_message(self, to: str, subject: str, message_text: str, file: str = None):
        if not file:
    ...
    def create_reply(self, reply_to: 'GMessage', message_text: str, file: str = None):
        ...
        reply_mes = self.create_message(to=to, subject=subject, message_text=message_text, file=file)
    ...
    def _create_attachment_message(self, to: str, subject: str, message_text: str, file: str):
        """Create a message for an email.
    ...
    def send_message(self, message):
        ...
        api_response = (self._messages_api().send(userId=self.user_id, body=api_package).execute())
        return api_response
